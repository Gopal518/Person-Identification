...
%4. "gt_bbox" file. It contains 25259 images, all hand-drawn. The images correspond to all the 1501 individuals 			%
%in the test and training set.It is used to distinguish "good" "junk" and "distractors".						%
%5. "gt_query" file. For each of the 3368 queries, there are both good and junk relevant images (containing the 			%
%same individual). This file contains the image index of the good and junk images. It is used during performance evaluation.	%
%       																%
%**********************************************************************************************************************************%
